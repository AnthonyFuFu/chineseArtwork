...
CREATE TABLE category (
    CAT_ID INT IDENTITY(1,1) NOT NULL PRIMARY KEY,     -- 分類ID
...
CREATE TABLE style (
    STYLE_ID INT IDENTITY(1,1) NOT NULL PRIMARY KEY,   -- 風格ID
...
CREATE TABLE artwork (
    ...
    CONSTRAINT FK_ARTWORK_ARTIST FOREIGN KEY (ART_ID) REFERENCES artist(ART_ID),
    CONSTRAINT FK_ARTWORK_CATEGORY FOREIGN KEY (CAT_ID) REFERENCES category(CAT_ID),
    CONSTRAINT FK_ARTWORK_STYLE FOREIGN KEY (STYLE_ID) REFERENCES style(STYLE_ID)
);
INSERT INTO artwork (
    ART_ID,
    CAT_ID,
